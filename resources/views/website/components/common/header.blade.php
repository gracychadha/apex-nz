            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="header-top-one-wrapper">
                        <div class="right">
                            <p>Welcome to Apex — Powering Smarter Tracking Solutions.<a href="#">Contact Us <i
                        ...
                        <div class="main-header">
                                                    ...
                                                    <div class="row g-5">
                                                            ...
                                                            <ul class="mega-menu-item parent-nav">
                                                                ...
                                                                <li>
                                                                    <a href="service-details-5.html">
                                                                        <div class="single-service-menu">
                                                                            <div class="icon">
                                                                                <img src="{{ asset('website/images/service/12.svg') }}"
                                                                                    alt="service">
                                                                            </div>
                                                                            <div class="info">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="menu-thumb pl--20">
                                                                <img src="{{ asset('website/images/banner/24.webp') }}" alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="button-area">
                                ...
                                <button id="menu-btn" class="menu menu-btn ml--20 ml_sm--5">
                                    <img class="menu-light" src="{{ asset('website/images/icons/01.svg') }}" alt="Menu-icon">
                                </button>
                            </div>
                        </div>
                    </div>
