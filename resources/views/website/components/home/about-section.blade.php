 <div class="rts-about-area-two rts-section-gap">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="left-thumbnail-about-area-two">
                        <img loading="lazy" src="{{ asset('website/images/about/04.webp') }}" alt="about">
                        <div class="small-image">
                            <img loading="lazy" src="{{ asset('website/images/about/05.webp') }}" alt="small">
                        </div>
        ...
        <div class="shape-area">
            <img loading="lazy" src="{{ asset('website/images/about/shape/01.svg') }}" alt="shape" class="one">
            <img loading="lazy" src="{{ asset('website/images/about/shape/02.svg') }}" alt="shape" class="two">
        </div>
    </div>