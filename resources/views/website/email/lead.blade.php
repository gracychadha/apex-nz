        ...
        <tr>
            <td align="center">
                ...
                <table width="600" cellpadding="0" cellspacing="0"
                    ...
                    <!-- Green Header -->
                    <tr>
                        <td style="background:#001e64; padding:25px; color:#ffffff;">
                    ...
                    <tr>
                        <td style="padding:25px 30px; color:#51627a; font-size:15px; line-height:1.7;">
                            ...
                            <strong>Team Apex</strong>
                        </td>
                    </tr>
                    <!-- Contact Button -->
                    <tr>
                        <td align="center" style="padding-bottom:25px;">
                            <a href="https://apex.vibrantick.org/contact-us" style="background:#001e64; color:#ffffff; padding:12px 25px; border-radius:4px;
                    ...
                    <tr>
                        <td align="center" style="background:#f4f7fb; padding:20px; color:#9aa3b5; font-size:12px;">
                            © {{ date('Y') }} Apex Nz — Reliable • Accurate • Trustworthy
                        </td>
                    </tr>
